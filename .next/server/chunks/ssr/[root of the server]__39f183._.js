...
const fetchFloorPrice = ()=>axios.get(`${API_BASE_URL}/collections`);
const fetchListings = ()=>axios.get(`${API_BASE_URL}/${SYMBOL}/listings`);
const fetchActivitesSales = ()=>axios.get(`${API_BASE_URL}/${SYMBOL}/activities`);
const fetchWalletNFTs = (walletAddress)=>axios.get(`${API_BASE_URL}/wallet/${walletAddress}`);
}}),
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$react$2c$__cjs$29$__ = __turbopack_import__("[externals]/ [external] (react, cjs)");
(()=>{
    const e = new Error("Cannot find module 'react-query'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
const CollectionPage = ()=>{
    const { data: floorPrice, isLoading: loadingFloorPrice } = useQuery('floorPrice', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["fetchFloorPrice"]);
    const { data: listings, isLoading: loadingListings } = useQuery('listings', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["fetchListings"]);
    const { data: sales, isLoading: loadingSales } = useQuery('sales', __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["fetchActivitesSales"]);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__39f183._.js.map